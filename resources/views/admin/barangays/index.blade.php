            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Manage barangays, assigned municipality, and purok count.
                    </p>
                </div>
            </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-[#e8f8f3] text-[#176895]">
                        ...
                        <th class="px-5 py-4 text-left font-black uppercase tracking-wide text-xs">Municipality</th>
                        <th class="px-5 py-4 text-center font-black uppercase tracking-wide text-xs">Purok Count</th>
                    ...
                    @forelse($barangays as $barangay)
                        <tr class="transition hover:bg-[#f3fbf8]">
                            ...
                            <td class="px-5 py-4">
                                @if($barangay->municipality)
                                    <span class="inline-flex items-center gap-2 rounded-xl bg-[#f3fbf8] border border-[#d8f0e9] px-3 py-1.5 text-xs font-bold text-[#17364a]">
                                        <i class="fa-solid fa-map-location-dot text-[#2f8fc1]"></i>
                            ...
                            <td class="px-5 py-4 text-center">
                                <span class="inline-flex items-center justify-center gap-2 rounded-xl bg-[#fff3dc] px-3 py-1.5 text-xs font-black text-[#f7a832]">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-5 py-12 text-center">
                                ...
                                <p class="text-sm text-gray-500 mt-1">
                                    Start by adding your first barangay record.
                                </p>
