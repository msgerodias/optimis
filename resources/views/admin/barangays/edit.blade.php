            ...
            <div class="mb-8 flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Update barangay information, assigned municipality, and purok count.
                    </p>
                </div>
            </div>

            <form method="POST" action="{{ route('admin.barangays.update', $barangay) }}" class="space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="font-black mb-1 text-[#17364a]">
                                Barangay Profile Update
                            </p>

                            <p class="leading-relaxed">
                                Changes here will affect barangay-level OPT monitoring, reporting, and child record organization.
                            </p>
                        </div>
                    </div>
                </div>
