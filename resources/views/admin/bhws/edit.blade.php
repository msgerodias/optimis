        ...
        <div class="mb-8 flex items-start gap-4">
            ...
            <div>
                ...
                <h2 class="mt-3 text-2xl font-black text-[#17364a]">
                    Edit Barangay Health Worker
                </h2>

                <p class="text-sm text-gray-500 mt-1">
                    Update BHW profile information and contact details.
                </p>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.bhws.update', $bhw) }}" class="space-y-7">
            @csrf
            @method('PUT')
            ...
            <div>
                <div class="mb-4 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Update the BHW's complete name.</p>
                    </div>
                </div>
            ...
            <div>
                <div class="mb-4 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Update profile contact and gender details.</p>
                    </div>
                </div>
            ...
            <div>
                ...
                <textarea name="address"
                          rows="4"
                          class="w-full rounded-2xl border border-[#d8f0e9] bg-white px-4 py-4 text-sm font-semibold text-gray-800 shadow-sm outline-none transition focus:border-[#2f8fc1] focus:ring-4 focus:ring-[#72c7b0]/25"
                          placeholder="Enter complete address">{{ old('address', $bhw->address) }}</textarea>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="leading-relaxed">
                            This will update the Barangay Health Worker profile information. The existing user account will remain connected to this BHW record.
                        </p>
                    </div>
                </div>
            </div>
