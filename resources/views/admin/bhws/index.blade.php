            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Manage Barangay Health Worker profiles and system accounts.
                    </p>
                </div>
            </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-[#e8f8f3] text-[#176895]">
                        <th class="px-5 py-4 text-left font-black uppercase tracking-wide text-xs">Name</th>
                        <th class="px-5 py-4 text-left font-black uppercase tracking-wide text-xs">Gender</th>
                        <th class="px-5 py-4 text-left font-black uppercase tracking-wide text-xs">Contact No.</th>
                        <th class="px-5 py-4 text-left font-black uppercase tracking-wide text-xs">Email Address</th>
                            ...
                            <td class="px-5 py-4">
                                @if($bhw->contact_no)
                                    <span class="inline-flex items-center gap-2 rounded-xl bg-[#f3fbf8] border border-[#d8f0e9] px-3 py-1.5 text-xs font-bold text-[#17364a]">
                                        <i class="fa-solid fa-phone text-[#2f8fc1]"></i>
                                        {{ $bhw->contact_no }}
                                    </span>
                                @else
                                    <span class="text-gray-400 font-semibold">N/A</span>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-5 py-12 text-center">
                                ...
                                <p class="text-sm text-gray-500 mt-1">
                                    Start by adding your first Barangay Health Worker account.
                                </p>
