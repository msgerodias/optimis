...
@section('title', 'Edit Child Record')

@section('content')

<form method="POST"
      action="{{ route('bhw.children.update', $child) }}"
    ...
    <div class="relative z-10">
        ...
        <div class="mb-8 flex items-start gap-4">
            ...
            <div>
                ...
                <h2 class="mt-3 text-2xl font-black text-[#17364a]">
                    Edit Child and Parent Information
                </h2>

                <p class="text-sm text-gray-500 mt-1">
                    Update child details and connected parent/guardian information.
                </p>
            </div>
        </div>
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-[#176895] leading-relaxed">
                        Update the child’s personal information, location, and purok assignment.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-5 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">Update the child’s complete name.</p>
            </div>
        </div>
        ...
        <div class="mb-5 mt-8 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">Update IP group, gender, birthday, and location details.</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
            <div>
                ...
                <select name="belongs_to_ip_group"
                        required
                        class="w-full rounded-2xl border border-[#d8f0e9] bg-white px-4 py-4 text-sm font-semibold text-gray-800 shadow-sm outline-none transition focus:border-[#2f8fc1] focus:ring-4 focus:ring-[#72c7b0]/25">
                    <option value="no" @selected(old('belongs_to_ip_group', $child->belongs_to_ip_group) === 'no')>
                        No
                    </option>
                    <option value="yes" @selected(old('belongs_to_ip_group', $child->belongs_to_ip_group) === 'yes')>
                        Yes
                    </option>
                </select>
            ...
            <div>
                ...
                <select name="gender"
                    ...
                    <option value="Male" @selected(old('gender', $child->gender) === 'Male')>
                        Male
                    </option>
                    <option value="Female" @selected(old('gender', $child->gender) === 'Female')>
                        Female
                    </option>
                </select>
            ...
            <div>
                ...
                <div class="relative group">
                    ...
                    <input type="date"
                           name="birthday"
                           value="{{ old('birthday', $child->birthday->format('Y-m-d')) }}"
                           required
                    ...
                    <select name="municipality_id"
                        ...
                        @foreach($municipalities as $municipality)
                            <option value="{{ $municipality->municipality_id }}"
                                @selected(old('municipality_id', $child->municipality_id) == $municipality->municipality_id)>
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-[#9b6500] leading-relaxed">
                        Update the connected parent or guardian details.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div>
                ...
                <input type="text"
                       ...
                       value="{{ old('parent_lastname', $child->parent->lastname) }}"
                       required
                       class="w-full rounded-2xl border border-[#d8f0e9] bg-white px-4 py-4 text-sm font-semibold text-gray-800 shadow-sm outline-none transition focus:border-[#2f8fc1] focus:ring-4 focus:ring-[#72c7b0]/25"
            ...
            <div>
                ...
                <input type="text"
                       ...
                       value="{{ old('parent_firstname', $child->parent->firstname) }}"
                       required
                       class="w-full rounded-2xl border border-[#d8f0e9] bg-white px-4 py-4 text-sm font-semibold text-gray-800 shadow-sm outline-none transition focus:border-[#2f8fc1] focus:ring-4 focus:ring-[#72c7b0]/25"
            ...
            <div>
                ...
                <input type="text"
                       ...
                       value="{{ old('parent_middlename', $child->parent->middlename) }}"
                       class="w-full rounded-2xl border border-[#d8f0e9] bg-white px-4 py-4 text-sm font-semibold text-gray-800 shadow-sm outline-none transition focus:border-[#2f8fc1] focus:ring-4 focus:ring-[#72c7b0]/25"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mt-5">
            <div>
                ...
                <div class="relative group">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('parent_contact_no', $child->parent->contact_no) }}"
                           class="w-full rounded-2xl border border-[#d8f0e9] bg-white px-4 py-4 pl-12 text-sm font-semibold text-gray-800 shadow-sm outline-none transition focus:border-[#2f8fc1] focus:ring-4 focus:ring-[#72c7b0]/25"
            ...
            <div>
                ...
                <div class="relative group">
                    ...
                    <input type="email"
                           ...
                           value="{{ old('parent_email_address', $child->parent->email_address) }}"
                           required
                           class="w-full rounded-2xl border border-[#d8f0e9] bg-white px-4 py-4 pl-12 text-sm font-semibold text-gray-800 shadow-sm outline-none transition focus:border-[#2f8fc1] focus:ring-4 focus:ring-[#72c7b0]/25"
            ...
            <div>
                ...
                <input type="text"
                       name="authorized_guardian"
                       value="{{ old('authorized_guardian', $child->parent->authorized_guardian) }}"
                       class="w-full rounded-2xl border border-[#d8f0e9] bg-white px-4 py-4 text-sm font-semibold text-gray-800 shadow-sm outline-none transition focus:border-[#2f8fc1] focus:ring-4 focus:ring-[#72c7b0]/25"
...
<script>
    ...
    const selectedBarangayId = "{{ old('barangay_id', $child->barangay_id) }}";
    const selectedPurok = "{{ old('purok', $child->purok) }}";
    ...
    function loadBarangays() {
        ...
        filteredBarangays.forEach(function (barangay) {
            const selected = barangay.brgy_id == selectedBarangayId ? 'selected' : '';
    ...
    function loadPuroks() {
        ...
        if (selectedBarangay) {
            for (let i = 1; i <= selectedBarangay.brgy_purok_count; i++) {
                const selected = i == selectedPurok ? 'selected' : '';
